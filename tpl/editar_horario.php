...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql_exist = "SELECT rowid FROM " . MAIN_DB_PREFIX . "picaje_horarios WHERE fk_user = " . (int)$user_id . " AND entity = " . (int)$conf->entity;
    ...
    if ($res_exist && $db->num_rows($res_exist)) {
        ...
        // Insert
        $sql = "INSERT INTO " . MAIN_DB_PREFIX . "picaje_horarios (fk_user, hora_salida, salida_automatica, entity) VALUES (" . (int)$user_id . ", '" . $db->escape($hora) . "', " . (int)$auto . ", " . (int)$conf->entity . ")";
    }
...
$sql_actual = "SELECT hora_salida, salida_automatica FROM " . MAIN_DB_PREFIX . "picaje_horarios WHERE fk_user = " . (int)$user_id . " AND entity = " . (int)$conf->entity;
