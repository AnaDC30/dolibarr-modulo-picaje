...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql_exist = "SELECT rowid FROM llx_picaje_horarios WHERE fk_departement = $grupo_id AND entity = " . (int) $conf->entity;
    ...
    if ($res_exist && $db->num_rows($res_exist)) {
        ...
        $sql = "INSERT INTO llx_picaje_horarios (fk_departement, hora_salida, salida_automatica, entity) 
                VALUES ($grupo_id, '" . $db->escape($hora) . "', $auto, " . (int) $conf->entity . ")";
    }
